...
\newcommand\csafelogo[1][width=14em]{\includegraphics[#1]{figures/logo.png}}
...
% Institution logo could go here

%---------------------------------------------------------------------------------
%	OBJECTIVES
%---------------------------------------------------------------------------------

\allhandsbox{Objectives}{name=objectives,column=0,row=0}{
\blinditemize[6]
}
...
\allhandsbox{Methods}{name=methods,column=0,below=objectives,above=bottom}{
\blindtext
\blinditemize[8]
\blindtext
}
...
\allhandsbox{Try it out!}{name=url,column=1,row=0,span=2}{
...
\allhandsbox{Other}{name=other,column=1,span=1,below=res1,above=bottom}{
\blindtext[2]
}
